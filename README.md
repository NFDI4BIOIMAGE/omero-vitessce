...
- images:
    A spatial view and a layer controller view are setup for the image.
- datasets:
   All images in the dataset are bundled togheter and a spatial view and a layer controller are setup.
